...
public class JalapenoModel<T extends Jalapeno> extends HierarchicalModel<T> {
	...
	public JalapenoModel(ModelPart root) {
		...
		this.stick = this.head.getChild("stick");
		this.inner = this.head.getChild("inner");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = bone.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -22.0F, -5.0F, 10.0F, 13.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(32, 15).addBox(-4.0F, -1.75F, -4.25F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F))
		...
		PartDefinition bottom = head.addOrReplaceChild("bottom", CubeListBuilder.create(), PartPose.offset(0.0F, -7.5F, 0.25F));
		...
		PartDefinition stick = head.addOrReplaceChild("stick", CubeListBuilder.create().texOffs(0, 30).addBox(0.0F, -9.0F, -7.0F, 0.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -22.0F, -0.5F));

		PartDefinition inner = head.addOrReplaceChild("inner", CubeListBuilder.create().texOffs(0, 38).addBox(-5.0F, -22.0F, -5.0F, 10.0F, 13.0F, 10.0F, new CubeDeformation(-0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
