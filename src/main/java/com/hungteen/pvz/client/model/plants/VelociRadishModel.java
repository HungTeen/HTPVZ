...
public class VelociRadishModel<T extends VelociRadish> extends HierarchicalModel<T> {
	private final ModelPart total;
	private final ModelPart root;

	public VelociRadishModel(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.hasSkill(VelociRadish.STRONG_SKILL_NAME)) {
			this.total.xScale = 1.5f;
			this.total.yScale = 1.5f;
			this.total.zScale = 1.5f;
		}
