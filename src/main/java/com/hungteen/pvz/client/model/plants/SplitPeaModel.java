...
public class SplitPeaModel<T extends SplitPea> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back = head.addOrReplaceChild("back", CubeListBuilder.create().texOffs(30, 0).addBox(-2.0F, -1.0F, -0.7F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(10, 32).addBox(-5.0F, -5.0F, 1.0F, 10.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.6F, 8.2F));

		PartDefinition mouth_r1 = back.addOrReplaceChild("mouth_r1", CubeListBuilder.create().texOffs(44, 0).addBox(-3.0F, -3.0F, -1.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 3.2F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition front = head.addOrReplaceChild("front", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -22.0F, -9.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(30, 0).addBox(-2.0F, -17.0F, -12.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(44, 0).addBox(-3.0F, -18.0F, -13.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 0.0F));
