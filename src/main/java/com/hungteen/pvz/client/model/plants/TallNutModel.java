...
public class TallNutModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(42, 45).addBox(-7.0F, -2.0F, -7.0F, 14.0F, 2.0F, 14.0F, new CubeDeformation(0.0F))
                .texOffs(0, 59).addBox(-7.0F, -27.0F, -7.6F, 14.0F, 25.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition eye_close = body.addOrReplaceChild("eye_close", CubeListBuilder.create().texOffs(0, 85).addBox(-7.0F, -27.0F, -7.7F, 14.0F, 25.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
