...
public class JalapenoRenderer<T extends Jalapeno> extends MobRenderer<T, EntityModel<T>> {
    ...
    public JalapenoRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new LightLayer<>(this, Util.prefix("textures/entity/plants/jalapeno/jalapeno_light.png"), (jalapeno, partialTicks, ageInTicks) -> 0.6F));
        this.addLayer(new LightLayer<>(this, Util.prefix("textures/entity/plants/jalapeno/jalapeno.png"), (jalapeno, partialTicks, ageInTicks) -> 0.3F));
    }
