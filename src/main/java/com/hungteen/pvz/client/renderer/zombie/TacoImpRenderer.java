...
public class TacoImpRenderer<T extends TacoImp, M extends TacoImpModel<T>> extends HumanoidMobRenderer<T, M> {
    ...
    public TacoImpRenderer(EntityRendererProvider.Context context) {
        super(context, (M) new TacoImpModel<T>(context.bakeLayer(PVZLayerHandler.LayerLocationMap.get("taco_imp:main"))), 0.5F);
