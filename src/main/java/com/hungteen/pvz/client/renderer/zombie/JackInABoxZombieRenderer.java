...
public class JackInABoxZombieRenderer<T extends JackInABoxZombie, M extends JackInABoxZombieModel<T>> extends HumanoidMobRenderer<T, M> {
    ...
    public JackInABoxZombieRenderer(EntityRendererProvider.Context context) {
        super(context, (M) new JackInABoxZombieModel<T>(context.bakeLayer(PVZLayerHandler.LayerLocationMap.get("jack_in_a_box_zombie:main"))), 0.5F);
