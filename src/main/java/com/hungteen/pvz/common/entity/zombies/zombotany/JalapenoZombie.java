 ...
 * {@link com.hungteen.pvz.common.entity.plants.Jalapeno}
 */
public class JalapenoZombie extends AbstractZombotanyZombie {
    ...
    public void explode() {
        ...
        if (!level.isClientSide) {
            for (Direction direction : List.of(Direction.EAST, Direction.WEST, Direction.SOUTH, Direction.NORTH)) {
                ...
                anger.setPos(this.position().add(0, 1.5, 0));
    ...
    public ResourceLocation getPlantTextureLocation() {
        return Util.prefix("textures/entity/plants/jalapeno/jalapeno.png");
    }

    @Override
    public String getPlantModelClassName() {
        return "com.hungteen.pvz.client.model.plants.JalapenoModel";
    }
