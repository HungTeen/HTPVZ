...
public class PVZTargetGoal extends Goal {
    ...
    public boolean canContinueToUse() {
        ...
        if(EntityUtil.checkCanEntityBeAttack(mob, entity) && (this.mustReach || (! this.mustSee || this.checkSenses(entity)))) {
    ...
    protected boolean checkSenses(LivingEntity entity) {
