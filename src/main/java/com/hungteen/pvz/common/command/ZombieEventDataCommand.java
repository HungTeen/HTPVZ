...
public class ZombieEventDataCommand extends DataCommands {
    ...
    public static final DataProvider TARGET_PROVIDER = ZombieEventDataAccessor.PROVIDER.apply("target");

    public static final DataProvider SOURCE_PROVIDER = ZombieEventDataAccessor.PROVIDER.apply("source");
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_139366_) {
        ...
        literalargumentbuilder.then(TARGET_PROVIDER.wrap(Commands.literal("merge"), (p_139471_) -> {
            return p_139471_.then(Commands.argument("nbt", CompoundTagArgument.compoundTag()).executes((p_142857_) -> {
                return mergeData(p_142857_.getSource(), TARGET_PROVIDER.access(p_142857_), CompoundTagArgument.getCompoundTag(p_142857_, "nbt"));
            }));
        })).then(TARGET_PROVIDER.wrap(Commands.literal("get"), (p_139453_) -> {
            return p_139453_.executes((p_142849_) -> {
                return getData(p_142849_.getSource(), TARGET_PROVIDER.access(p_142849_));
            }).then(Commands.argument("path", NbtPathArgument.nbtPath()).executes((p_142841_) -> {
                return getData(p_142841_.getSource(), TARGET_PROVIDER.access(p_142841_), NbtPathArgument.getPath(p_142841_, "path"));
            }).then(Commands.argument("scale", DoubleArgumentType.doubleArg()).executes((p_142833_) -> {
                return getNumeric(p_142833_.getSource(), TARGET_PROVIDER.access(p_142833_), NbtPathArgument.getPath(p_142833_, "path"), DoubleArgumentType.getDouble(p_142833_, "scale"));
            })));
        })).then(TARGET_PROVIDER.wrap(Commands.literal("remove"), (p_139413_) -> {
            return p_139413_.then(Commands.argument("path", NbtPathArgument.nbtPath()).executes((p_142820_) -> {
                return removeData(p_142820_.getSource(), TARGET_PROVIDER.access(p_142820_), NbtPathArgument.getPath(p_142820_, "path"));
            }));
    ...
    private static ArgumentBuilder<CommandSourceStack, ?> decorateModification(BiConsumer<ArgumentBuilder<CommandSourceStack, ?>, DataManipulatorDecorator> p_139404_) {
        ...
        TARGET_PROVIDER.wrap(literalargumentbuilder, (p_139408_) -> {
            ...
            p_139404_.accept(argumentbuilder, (p_142807_) -> {
                return SOURCE_PROVIDER.wrap(Commands.literal("from"), (p_142812_) -> {
                    return p_142812_.executes((p_142830_) -> {
                        List<Tag> list = Collections.singletonList(SOURCE_PROVIDER.access(p_142830_).getData());
                        return manipulateData(p_142830_, TARGET_PROVIDER, p_142807_, list);
                    }).then(Commands.argument("sourcePath", NbtPathArgument.nbtPath()).executes((p_142817_) -> {
                        DataAccessor dataaccessor = SOURCE_PROVIDER.access(p_142817_);
                        ...
                        return manipulateData(p_142817_, TARGET_PROVIDER, p_142807_, list);
                    }));
                });
            });
            p_139404_.accept(argumentbuilder, (p_142799_) -> {
                return Commands.literal("value").then(Commands.argument("value", NbtTagArgument.nbtTag()).executes((p_142803_) -> {
                    ...
                    return manipulateData(p_142803_, TARGET_PROVIDER, p_142799_, list);
                }));
            });
