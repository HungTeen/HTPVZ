...
public class PVZItems {
    ...
    public static final RegistryObject<Item> GOLDEN_TACO = item("golden_taco", () -> new DisappearableItem((new Item.Properties()).tab(CreativeModeTab.TAB_FOOD).durability(75).rarity(Rarity.RARE).food((new FoodProperties.Builder()).nutrition(6).saturationMod(1.2F).effect(() -> new MobEffectInstance(PVZMobEffects.EXCITEMENT.get(), 150, 5), 1).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200), 1).effect(() -> new MobEffectInstance(MobEffects.SATURATION, 10), 1).effect(() -> new MobEffectInstance(PVZMobEffects.BRIGHTNESS.get(), 600, 2), 1).alwaysEat().build()), () -> TACO.get()));
